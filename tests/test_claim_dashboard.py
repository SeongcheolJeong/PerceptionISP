...
class ClaimDashboardTest(unittest.TestCase):
    ...
    def test_dashboard_separates_supported_and_blocked_claims(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue(dashboard["dense_input_ablation_gate"]["pass"])
            self.assertEqual(dashboard["dense_input_ablation_gate"]["claim_status"], "aux_input_used_by_dense_dnn")
            ...
            self.assertIn("RGB+Aux DNN input-ablation gate", evidence_areas)
    ...
    def test_dashboard_cli_outputs_compact_result(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue(summary["dense_select_test_gate"]["pass"])
            self.assertEqual(summary["dense_select_test_gate"]["claim_status"], "strict_fair_tuned_rgb_baseline_heldout_pass")
