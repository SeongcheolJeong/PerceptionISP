...
from perception_isp.datasets.aodraw_download_plan import CLEANUP_CONFIRM_TOKEN, _cleanup_candidates, _cleanup_summary, _disk_summary
...
def _execute_command(selected: Sequence[Mapping[str, Any]]) -> str:
    ...
    return (
        "perception-isp data aodraw-cleanup "
