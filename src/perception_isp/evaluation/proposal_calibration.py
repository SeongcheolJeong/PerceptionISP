...
from perception_isp.evaluation.metrics import aggregate_metric_rows, box_iou, evaluate_detections
from perception_isp.evaluation.threshold_sweep import parse_thresholds
...
def apply_proposal_calibration_to_report(
    ...
    *,
    ...
    from perception_isp.evaluation.comparison import _aggregate_breakdown, _input_names_from_samples, _sample_breakdown
