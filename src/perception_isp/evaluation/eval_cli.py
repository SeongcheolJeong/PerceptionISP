...
from perception_isp.core.detectors import UltralyticsYOLODetector, detector_from_name, rgb_aux_detector_from_checkpoint
...
def main(argv: Any = None) -> int:
    ...
    if args.source == "camerae2e-synthetic":
        ...
        from perception_isp.evaluation.image_eval import DEFAULT_SAMPLE_IMAGE_URL, make_yolo_pseudo_label_sample
...
def parse_label_keep(value: str | None) -> tuple[str, ...]:
    ...
    if preset in {"coco80", "coco-80", "aodraw-coco-overlap", "aodraw-to-coco-overlap"}:
        from perception_isp.datasets.yolo_dataset import COCO80_CLASS_NAMES
