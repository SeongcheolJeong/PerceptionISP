...
_CANONICAL_MODULE = "perception_isp.training.yolo_aux_train"
_LEGACY_CHECKPOINT_MODULE = "perception_isp.yolo_aux_train"
sys.modules.setdefault(_LEGACY_CHECKPOINT_MODULE, sys.modules[__name__])
...
def main(argv: Any = None) -> int:
    ...
    parser.add_argument(
        ...
        type=float,
        default=-2.0,
        help="Initial gate logit for Aux branch. -2.0 starts with roughly 12 percent Aux contribution.",
    )
    parser.add_argument(
