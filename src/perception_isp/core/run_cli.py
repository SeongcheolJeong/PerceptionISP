...
from perception_isp.core.camerae2e_bridge import camerae2e_or_synthetic_raw
...
def main(argv: Any = None) -> int:
    ...
    parser.add_argument(
        "--output-dir",
        default=str(output_root() / "perception_isp_demo"),
        help="Directory for npz/json/ppm outputs.",
    )
