...
def _load_scene_edge_confidence_one(spec: str | Path) -> Dict[str, Any]:
        ...
        cases.append(
            {
                ...
                "perception_aux_confidence_minus_human_source_edge_f1": _maybe_float(
                    metrics.get("perception_aux_confidence_minus_human_source_edge_f1")
                ),
            }
        )
    status = str(data.get("status", ""))
    return {
        ...
        "perception_aux_confidence_minus_human_source_edge_f1_mean": _maybe_float(
...
def _scene_edge_evidence(scene_edge: Mapping[str, Any]) -> str:
    ...
    return (
        ...
        f"aux-confidence dF1={_fmt(scene_edge.get('perception_aux_confidence_minus_human_source_edge_f1_mean'), signed=True)}; "
        f"RGB win={_fmt(scene_edge.get('perception_rgb_source_edge_f1_win_rate'))}; "
        f"aux-strength win={_fmt(scene_edge.get('perception_aux_strength_source_edge_f1_win_rate'))}; "
        f"aux-confidence win={_fmt(scene_edge.get('perception_aux_confidence_source_edge_f1_win_rate'))}"
    )
...
def _scene_edge_html(scene_edge: Mapping[str, Any], destination: Path) -> str:
    ...
    return (
        ...
        "<table>"
        "<thead><tr><th>Report</th><th>Cases</th><th>Checks</th><th>CFA</th><th>LensPSF</th><th>Failed</th><th>Human F1</th><th>Perception RGB F1</th><th>RGB Delta</th><th>RGB Win Rate</th><th>Aux Strength F1</th><th>Aux Strength Delta</th><th>Aux Strength Win Rate</th><th>Aux Confidence F1</th><th>Aux Confidence Delta</th><th>Aux Confidence Win Rate</th></tr></thead>"
        "<tbody><tr>"
        ...
        f"<td>{_fmt(scene_edge.get('perception_aux_confidence_minus_human_source_edge_f1_mean'), signed=True)}</td>"
        f"<td>{_fmt(scene_edge.get('perception_aux_confidence_source_edge_f1_win_rate'))}</td>"
        "</tr></tbody></table>"
        "<table>"
        "<thead><tr><th>Evidence Report</th><th>Report</th><th>Cases</th><th>Checks</th><th>CFA</th><th>LensPSF</th><th>RGB Delta</th><th>Aux Strength Delta</th><th>Aux Confidence Delta</th><th>Status</th></tr></thead>"
        f"<tbody>{report_rows}</tbody></table>"
        "<table>"
        "<thead><tr><th>Case</th><th>Source</th><th>CFA</th><th>Human F1</th><th>Perception RGB F1</th><th>RGB Delta</th><th>Aux Strength F1</th><th>Aux Strength Delta</th><th>Aux Confidence F1</th><th>Aux Confidence Delta</th></tr></thead>"
        f"<tbody>{case_rows}</tbody></table>"
    )
...
def _scene_edge_report_row(row: Mapping[str, Any], destination: Path) -> str:
    ...
    return (
        ...
        f"<td>{_fmt(row.get('perception_aux_confidence_minus_human_source_edge_f1_mean'), signed=True)}</td>"
...
def _scene_edge_case_row(row: Mapping[str, Any]) -> str:
    return (
        ...
        f"<td>{_fmt(row.get('perception_aux_confidence_minus_human_source_edge_f1'), signed=True)}</td>"
        "</tr>"
    )
