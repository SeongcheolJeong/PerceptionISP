...
| Evidence / Claiming | paired-bootstrap claim gates, broad-superiority and FP-reducer profiles, RGB+aux training rollup, claim-readiness dashboard, one-shot readiness orchestration |
